...
public class HttpUtils {
    ...
    public static void get( String url, Map<String,Object> requestBody, Map<String,String> requestHeader, HttpUtilsCallback call){
    ...
    public static void post( String url, Map<String,Object> requestBody, Map<String,String> requestHeader, HttpUtilsCallback call){
        http_Async(url,"POST",requestBody,requestHeader,call);
    }

 
 
    public static void http_Async(final String url,final String httpMethod,final Map<String,Object> requestBody,final Map<String,String> requestHeader,final HttpUtilsCallback call){
