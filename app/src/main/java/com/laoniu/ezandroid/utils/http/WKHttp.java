...
public class WKHttp {
    ...
    public static void post( String url, Map<String,Object> requestBody, WKHttpCallback call){
        http_Async(url,"POST",requestBody,null,call);
    }
    public static void get( String url, Map<String,Object> requestBody,WKHttpCallback call){
        http_Async(url,"GET",requestBody,null,call);
    }
 
    public static void post( String url, Map<String,Object> requestBody, Map<String,String> requestHeader, WKHttpCallback call){
        http_Async(url,"POST",requestBody,requestHeader,call);
    }
    public static void get( String url, Map<String,Object> requestBody, Map<String,String> requestHeader, WKHttpCallback call){
        http_Async(url,"GET",requestBody,requestHeader,call);
    }
 
 
    public static void http_Async(final String url,final String httpMethod,final Map<String,Object> requestBody,final Map<String,String> requestHeader,final WKHttpCallback call){
        final WKHttp http = new WKHttp();
    ...
    public void http_Sync(String url,String httpMethod,Map<String, Object> param,Map<String,String> requestHeader,Handler handler) {
    ...
    private Handler getHandler(final WKHttpCallback call){
        if(null==handler){
